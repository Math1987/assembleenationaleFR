...
exports.findOnText = exports.readOne = exports.create = exports.init = exports.schema = void 0;
...
exports.schema.index({ text: "text" });
var model;
var init = function (db_) {
    db = db_;
    model = db.model('articles', exports.schema);
};
exports.init = init;
...
var findOnText = function (words) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model.find({ $text: {
                        $search: words,
                        $language: "fr"
                    } })];
            case 1: return [2 /*return*/, _a.sent()];
